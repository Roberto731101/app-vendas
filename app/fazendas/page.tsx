...
import { FazendasTable } from '@/components/fazendas/FazendasTable'
...
export default function FazendasPage() {
  const { registros, carregando, erro, mensagem, excluir } = useFazendas()
    ...
    <AppLayout sidebarNavItems={NAV_SIDEBAR} headerNavItems={NAV_HEADER}>
      ...
      <div className="overflow-hidden rounded-2xl bg-white shadow-sm">
        ...
        {carregando ? (
          ...
          <FazendasTable registros={registros} onExcluir={excluir} />
        )}
      </div>
    </AppLayout>
  )
